...
type WebAppServiceStorePlace = {
  readonly methodName: string;
  readonly service: typeof WebAppService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof messages_pb.StorePlaceRequest;
  readonly responseType: typeof messages_pb.StorePlaceResponse;
};
...
export class WebAppService {
  ...
  static readonly StorePlace: WebAppServiceStorePlace;
}
...
export class WebAppServiceClient {
  ...
  storePlace(
    requestMessage: messages_pb.StorePlaceRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: messages_pb.StorePlaceResponse|null) => void
  ): UnaryResponse;
  storePlace(
    requestMessage: messages_pb.StorePlaceRequest,
    callback: (error: ServiceError|null, responseMessage: messages_pb.StorePlaceResponse|null) => void
